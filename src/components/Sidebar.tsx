...
const Sidebar: React.FC<SidebarProps> = ({ index, setIndex, currentCrowd }) => {
  return (
    <div className="z-20 flex h-fit w-full flex-row flex-wrap justify-start gap-2  rounded-t-3xl bg-blue-950 p-2 lg:h-full lg:w-[240px] lg:flex-col lg:justify-center lg:overflow-auto lg:rounded-none">
      <div className="flex h-fit w-full items-center py-2">
